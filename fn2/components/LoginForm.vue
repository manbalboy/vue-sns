    ...
    <v-container v-else>
        <v-card>
            <v-container>
                ...
                <v-row>
                    <v-col cols="4">{{ FollowingsLength }} 팔로잉</v-col>
                    <v-col cols="4">{{ FollowersLength }} 팔로워</v-col>
                    <v-col cols="4">{{ PostsLength }} 게시글</v-col>
                </v-row>
            </v-container>
        </v-card>
    </v-container>
...
<script>
    export default {
        ...
        computed: {
            ...
            FollowingsLength() {
                return this.me.Followings ? this.me.Followings.length : 0;
            },

            FollowersLength() {
                return this.me.Followers ? this.me.Followers.length : 0;
            },

            PostsLength() {
                return this.me.Posts ? this.me.Posts.length : 0;
            },
        },
        methods: {
            onSubmitForm() {
